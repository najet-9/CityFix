...
class _WelcomeButton extends StatefulWidget {
  final String text;
  final bool filled; // true = white filled button, false = transparent outlined button
...
class _WelcomeButtonState extends State<_WelcomeButton> {
  bool _pressed = false; // Tracks whether the button is currently being held down
