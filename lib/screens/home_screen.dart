...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    String userName = user?.email?.split('@')[0] ?? "Racha";
              ...
              child: Row(
                ...
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text("⚫ Pothole", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                      const SizedBox(height: 4),
                      const Text("Main Street, Downtown", style: TextStyle(color: Colors.grey, fontSize: 12)),
                    ],
                  ),
                  Container(
                    ...
                    child: const Text("👍 12 confirm", 
                      style: TextStyle(color: Color(0xFF2B58E4), fontWeight: FontWeight.bold, fontSize: 12)),
                  )
                ],
              ),
            )
